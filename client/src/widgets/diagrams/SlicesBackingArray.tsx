...
const FRAMES: Frame[] = [
  ...
  { code: 't = append(t, 4)', caption: 'No room left: append allocates a new array, copies, and t now points there. Capacity 6 is illustrative; actual growth is implementation-dependent. s still points at the old array.', array: [1, 2, 99, 4, null, null], arrayLabel: 'backing array B · cap 6 (A still holds 1, 2, 99 for s)', slices: [{ name: 's', start: 0, len: 3, cap: 3, stale: true }, { name: 't', start: 0, len: 4, cap: 6 }], changed: 3 },
]
